...
public class TalentDonationProjectService {
	...
	public TalentDonationProject getDonationProject(String projectName) {
		// 기존 코드
		/*
		 * for (TalentDonationProject project : donationProjectList) { if (project !=
		 * null && project.getTalentDonationProjectName().equals(projectName)) { return
		 * project; // 메소드 자체의 종료 } } return null;
		 */
	...
	public void donationProjectUpdate(String projectName, Donator people) throws Exception {
		...
		/*
		 * for (TalentDonationProject project : donationProjectList) { if (project !=
		 * null && project.getTalentDonationProjectName().equals(projectName)) { if
		 * (people != null) { project.setProjectDonator(people); break; } else { throw
		 * new Exception("프로젝트 이름은 있으나 기부자 정보 누락 재확인 하세요"); } } else { throw new
		 * Exception("프로젝트 이름과 기부자 정보 재 확인 하세요"); } }
		 */
	...
	public void beneficiaryProjectUpdate(String projectName, Beneficiary people) throws Exception {
		...
		/*
		 * for (TalentDonationProject project : donationProjectList) { if (project !=
		 * null && project.getTalentDonationProjectName().equals(projectName)) {
		 * project.setProjectBeneficiary(people); break; } }
		 */
