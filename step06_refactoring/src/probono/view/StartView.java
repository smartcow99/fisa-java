...
public class StartView {
	...
	public static void main(String[] args) {
		...
		// Donators
		List<Donator> donators = Arrays.asList(new Donator(7369, "김의사", "kimdoc@company.com", "슈바이처 프로젝트"),
		...
		// Beneficiaries
		List<Beneficiary> beneficiaries = Arrays.asList(new Beneficiary(100, "김연약", "010-111-1111", "슈바이처 프로젝트"),
		...
		List<TalentDonationType> talentDonationTypes = Arrays.asList(new TalentDonationType("슈바이처 프로젝트",
				"의료, 보건, 건강과 관련된 분야",
				...
				new TalentDonationType("마더테레사 프로젝트", "저소득층 및 사회복지 분야", "사회복지 관련 시설기관 봉사 및 후원, 독거노인 돌봄, 그룹홈, 쉼터 지원등"),
